...
export const Hero = () => {
  return (
    <>
      <div
        className="relative bg-cover bg-center bg-no-repeat h-screen flex items-center p-8 mt-16"
      ...
      >
        ...
        <div
          className="absolute top-24 left-8 w-48 h-32 bg-cover bg-no-repeat"
          style={{
            backgroundImage: "url('/img/brands/Graphics/AWARDS LOGO.png')",
          }}
        >
          {" "}
        </div>

        <Container className="flex flex-wrap bg-cover p-4 relative z-10">
          <div className="flex items-center w-full lg:w-1/2 flex-wrap px-36">
            <div className="max-w-2xl mb-8">
              <h3
                className=" font-bold text-5xl text-custom-gold"
                style={{
                  fontFamily: "Roboto, sans-serif",
                  letterSpacing: "0.05em",
                  lineHeight: "1.2",
                  textShadow: "0px 3px 6px rgba(0, 0, 0, 0.30)",
                  opacity: 1,
                }}
              >
                ALT PRO EXPO
              </h3>
              <h1 className="text-8xl font-bold leading-none tracking-tight text-gray-white">
                EXCELLENCE AWARDS
              </h1>
            </div>
          </div>
      ...
      <div>
        <Container2 className="bg-no-repeat bg-center max-w-full">
          <div className="max-w-6xl mx-auto flex justify-center items-center min-h-[40vh]">
            <div className="flex items-center gap-8 w-full px-6 justify-between mb-0">
              {/* Título rotado centrado verticalmente */}
              <div className="flex items-center justify-center h-full ">
                <div className="relative -rotate-90 origin-left transform translate-x-1/4 left-36 top-16">
              ...
              {/* Párrafo centrado y justificado */}
              <div className="flex-1 max-w-4xl mt-0 ">
                <p className="font-poppins font-medium text-base leading-[27px] tracking-[-0.18px] text-white text-justify opacity-85">
                  The Alt Pro Expo Excellence Awards are a prestigious
                  recognition within the alternative products industry,
                  celebrating the most innovative, high-quality, and impactful
                  brands, products, and professionals. Winning an Alt Pro Expo
                  Excellence Award not only highlights your brand as a leader in
                  the industry but also enhances your reputation and visibility
                  among key players and consumers alike. This award serves as a
                  powerful endorsement, setting your brand apart from the
                  competition and positioning you as a benchmark of excellence
                  in the alternative products market.
                </p>
              </div>
            </div>
          </div>
