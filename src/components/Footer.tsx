      ...
      <Container>
        <div className="grid max-w-screen-2xl grid-cols-1 py-16 mx-auto lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex mt-5 space-x-6 text-white">
          ...
          <div className="text-white text-sm leading-relaxed text-center">
            <p>
              Privacy Policy • Terms & Conditions (Attendee/Exhibitor) • Notice
              of Filming & Photography
            </p>
            <p className="mt-2">
              2020-2025 ALTERNATIVE PRODUCTS EXPO, ZJ EVENTS LLC. All Rights
              Reserved.
            </p>
          </div>

          {/* Columna 3: Disclaimer */}
          <div className="text-white text-sm leading-relaxed px-8 text-justify">
            <p>
